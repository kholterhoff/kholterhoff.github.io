...
|**Week 12**|Monday, April 2 | Tutorial with <a href="https://wiki.htrc.illinois.edu/display/COM/HTRC+Data+Capsule+Tutorial">In-class instructions from Ximin Mi: “If any of them get some interesting results in Voyant, they need to save that content in secure_volume folder for output (already written in my instruction), they can move along to try take content out of Hathitrust. More instruction about taking the results out of Hathitrust is on their website as step 13</a> |
